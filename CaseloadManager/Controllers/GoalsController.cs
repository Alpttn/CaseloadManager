...
namespace CaseloadManager.Controllers
{
    public class GoalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GoalId,Title,Description,ClientId")] Goal goal)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["ClientId"] = new SelectList(_context.Clients, "ClientId", "FirstInitial", goal.ClientId);
            return View(goal);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GoalId,Title,Description,ClientId")] Goal goal)
        {
            if (id != goal.GoalId)
            {
                return NotFound();
